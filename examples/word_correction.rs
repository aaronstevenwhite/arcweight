...
fn main() -> Result<()> {
    ...
    let dictionary = vec![
        "hello", "world", "help", "held", "hell", "hold", "hero",
        "here", "hear", "heap", "heal", "health", "helm", "helps",
        "friend", "friends", "friendship", "friendly", "fresh",
        "spell", "spelling", "spelled", "spells", "special",
        "check", "checking", "checked", "checker", "checks",
        "correct", "correction", "corrected", "correctly", "corrects",
        "example", "examples", "exemplary", "exempt", "exemplify"
    ];
    ...
    for (misspelled, max_distance) in test_words {
        println!("Finding corrections for '{}' (max edit distance: {}):", 
        ...
        if corrections.is_empty() {
            println!("  No corrections found within edit distance {}", max_distance);
        } else {
